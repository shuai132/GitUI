...
- **工作区入口**：父仓库工作区中的 submodule gitlink 变更会以专用项显示，右键可直接打开已克隆的 submodule 仓库；未 init、未 clone 或工作区不存在时打开动作禁用。
- **历史入口**：提交详情中的 submodule gitlink 变更同样支持右键打开当前工作区中的对应 submodule 仓库，便于从历史 diff 快速切到子仓库上下文。
