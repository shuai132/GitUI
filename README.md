...
- [x] 设置面板：界面语言（跟随系统 / 中文 / English）、主题（跟随系统 / 浅色 / 深色）、UI / 代码字体字号、强调色覆盖、行分隔线强度/样式、提交图分叉样式、远程分支显示、历史列表列显示、Diff 默认布局与 hunk 分组、外部终端、视图开关；支持正式版自动更新与手动安装 `main` 最新开发版（无需 Release）
...
- 应用内可在「设置 → 更新」点击「检查开发版」，直接安装 `main` 分支最新成功构建；开发版仍会验证更新签名。
