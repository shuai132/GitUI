...
- [x] 多仓库管理：侧边栏快速切换、Submodule 仓库子树展示、路径持久化、关闭窗口隐藏到系统托盘、仓库右键菜单（复制名称 / 复制绝对路径 / 新窗口 / Finder / 终端）
...
- [x] 提交操作：checkout、远程分支 chip 快速检出、cherry-pick、revert、reset（soft / mixed / hard）、创建 tag、修改提交信息（HEAD 走 amend，历史提交走 rebase reword）
