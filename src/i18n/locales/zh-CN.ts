...
const messages = {
  ...
  diff: {
    markdown: {
      displayMode: 'Markdown 显示方式',
      source: '源码差异',
      preview: '修改后预览',
      compare: '渲染对照',
      wrap: 'Markdown 源码自动换行',
      ...
      showDiagram: '查看图表',
      diagram: 'Mermaid 图表',
      diagramPending: '滚动到此处以加载图表',
      diagramError: '图表无法渲染，请检查 Mermaid 语法。下方保留源码。',
      diagramTooLarge: '图表过大，请查看源码或简化图表。',
      zoomIn: '放大图表',
      zoomOut: '缩小图表',
      resetZoom: '恢复原始大小',
      empty: '空文档',
      added: '此文件为新增文件，修改前不存在。',
      deleted: '此文件已删除，没有修改后内容。可切换到渲染对照查看旧版。',
      tooLarge: '文档过大或结构过于复杂，请切换到源码差异查看。',
      loadError: '无法读取完整文档，请重试或查看源码差异。',
      renderError: 'Markdown 渲染失败，请切换到源码差异查看。',
      remoteImagesHidden: '网络图片已隐藏，可在上方勾选「加载网络图片」。',
      relativeImages: '仓库相对图片暂不支持预览，以下显示图片描述。',
      unresolvedLink: '无法在预览中打开此相对链接或定位此标题。',
      openLinkFailed: '无法打开链接。',
      head: '修改前 · HEAD',
      index: '修改前 · 暂存区',
      indexAfter: '修改后 · 暂存区',
      worktree: '修改后 · 工作区（已保存）',
      before: '修改前',
      after: '修改后 · 当前提交',
      settingsHint: 'Markdown 文件可选择源码、修改后文档或两侧渲染；也可在 Diff 工具栏切换。',
      wrapHint: '源码差异中的长段落自动换行，保留左右行号对齐。',
      mermaidHint: '预览中的 Mermaid 代码块按需渲染为图表，可单独查看源码。',
    },
  ...
  settings: {
    ...
    about: {
      ...
      openReleasesFailed: '无法打开 GitHub Releases',
      downloading: '正在下载...',
      updateDownloaded: '下载完成，重启以应用更新',
      updateError: '更新失败',
      updateNow: '立即更新',
      restartNow: '立即重启',
      restartFailed: '无法重启应用',
      skipVersion: '跳过此版本',
      lastChecked: '上次检查：{time}',
      neverChecked: '尚未检查更新',
      noUpdateFound: '当前已经是最新版本。',
      checkUpdate: '检查更新',
      checkDevelopmentUpdate: '检查开发版',
      noDevelopmentUpdateFound: '当前已经是最新开发版，或 main 分支暂无可用构建。',
      developmentUpdateHint: '开发版来自 main 分支最新成功构建，不创建或依赖 Release。',
      developmentAutoCheck: '启动时自动检查开发版',
      developmentAutoCheckHint: '发现新构建时只提示，不会静默安装。',
      developmentUpdateAvailable: '发现开发版更新',
      developmentBuildDetails: '开发版构建',
      developmentUpdateWarning: '开发版包含尚未正式发布的改动，稳定性可能低于正式版本。',
      checking: '正在检查...',
    },
  },
  fileHistory: {
