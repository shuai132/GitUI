...
const messages = {
  ...
  workspace: {
    ...
    confirmDiscard: {
      file: 'Discard unstaged changes to "{file}"? The current version will be moved to the system Trash for recovery.',
      selected: 'Discard changes to {count} selected file(s)? Their current versions will be moved to the system Trash for recovery.',
