...
const messages = {
  ...
  sidebar: {
    ...
    branch: {
      ...
      confirmDelete: 'Delete local branch "{name}" ({oid})? This cannot be undone.',
      confirmDeleteRemote: 'Delete remote branch "{name}" ({oid})? This cannot be undone.',
      confirmDeleteWithRemote: 'Delete local branch "{name}" ({oid})?\n\nIt tracks "{upstream}" ({upstreamOid}); you can delete that exact remote branch first.',
      confirmDeleteGoneUpstream: 'Delete local branch "{name}" ({oid})?\n\nIts configured upstream "{upstream}" is gone, so only the local branch will be deleted.',
  ...
  branchList: {
    ...
    confirmDelete: 'Delete branch "{name}" ({oid})? This cannot be undone.',
    deleteContextChanged: 'The repository or branch target changed. Select the branch again.',
  ...
  diff: {
    markdown: {
      displayMode: 'Markdown display mode',
      source: 'Source diff',
      preview: 'Preview changes',
      compare: 'Rendered comparison',
      wrap: 'Wrap Markdown source',
      ...
      retry: 'Retry',
      outline: 'Outline',
      jumpHeading: 'Jump to heading…',
      code: 'Code',
      copyCode: 'Copy code',
      showCode: 'Show source',
      showDiagram: 'Show diagram',
      diagram: 'Mermaid diagram',
      diagramPending: 'Scroll here to load the diagram',
      diagramError: 'Unable to render this diagram. Check the Mermaid syntax; source is shown below.',
      diagramTooLarge: 'Diagram is too large. View the source or simplify the diagram.',
      zoomIn: 'Zoom in',
      zoomOut: 'Zoom out',
      resetZoom: 'Reset zoom',
      empty: 'Empty document',
      added: 'New file. No content exists before this change.',
      deleted: 'Deleted file. Switch to rendered comparison to view the previous version.',
      tooLarge: 'Document is too large or complex. Switch to source diff to view it.',
      loadError: 'Unable to read the complete document. Retry or view the source diff.',
      renderError: 'Unable to render Markdown. Switch to source diff to view it.',
      remoteImagesHidden: 'Remote images are hidden. Enable “Load remote images” above to display them.',
      relativeImages: 'Repository-relative images are not supported yet; image descriptions are shown below.',
      unresolvedLink: 'This relative link or heading cannot be opened in the preview.',
      openLinkFailed: 'Unable to open the link.',
      head: 'Before · HEAD',
      index: 'Before · Index',
      indexAfter: 'After · Index',
      worktree: 'After · Worktree (saved)',
      before: 'Before',
      after: 'After · Selected commit',
      settingsHint: 'Choose source diff, the modified document, or a rendered comparison. Also available in the Diff toolbar.',
      wrapHint: 'Wrap long paragraphs in source diffs while keeping both sides aligned.',
      mermaidHint: 'Render Mermaid code blocks on demand in previews, with an option to view their source.',
    },
  ...
  settings: {
    ...
    plugins: {
      ...
      confirmUninstall: 'Uninstall "{name}" v{version}?\n\nPlugin ID: {id}\nInstalled copy: {path}\n\nThe installed copy will be moved to the system Trash. The original source folder is not changed.',
      uninstallContextChanged: 'The plugin changed after confirmation opened. Review it and try again.',
    ...
    about: {
      ...
      openReleasesFailed: 'Could not open GitHub Releases',
      ...
      checkDevelopmentUpdate: 'Check Development Build',
      noDevelopmentUpdateFound: 'You are using the latest development build, or no main-branch build is available.',
      developmentUpdateHint: 'Development updates come from the latest successful main-branch build and do not use Releases.',
      developmentAutoCheck: 'Check development builds on startup',
      developmentAutoCheckHint: 'New builds are only announced and never installed silently.',
      developmentUpdateAvailable: 'Development Update Available',
      developmentBuildDetails: 'Development Build',
      developmentUpdateWarning: 'This build contains changes that have not been released and may be less stable.',
      checking: 'Checking...',
    },
  },
  fileHistory: {
